 ...
 * @returns {Promise}
 */
export const exportEvaluationAPI = (id, format = 'pdf') => {
  return request.get(`/evaluations/${id}/export`, {
    params: { format },
    responseType: 'blob'
  })
}
...
export const saveDraftAPI = (data) => {
  return request.post('/evaluations/draft', data)
}
...
export const getDraftAPI = () => {
  return request.get('/evaluations/draft')
}
...
export const deleteDraftAPI = () => {
  return request.delete('/evaluations/draft')
}